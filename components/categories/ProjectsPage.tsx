...
function ShadowHeading({
  ...
  return (
    <motion.div
      className={`absolute ${styles} nth-child`}
      animate={{
        x: x,
        y: y,
      }}
...
export default function ProjectsPage() {
  ...
  return (
    ...
    >
      <section className=" flex flex-col items-center  gap-5  h-screen relative p-24  mt-16">
        <div className="text-7xl uppercase avant-garde min-h-16">
          <ShadowHeading coords={coords} styles="text-red-600 " index={0} />
          <ShadowHeading coords={coords} styles="text-purple-500" index={1} />
          <ShadowHeading coords={coords} styles="text-green-500" index={2} />
          <ShadowHeading coords={coords} styles="text-black" index={3} />

          <h1 className="text-transparent">Projects</h1>
        </div>
        ...
        <div className="w-full flex flex-col  py-20 px-10 md:px-20    gap-y-24 items-center  ">
